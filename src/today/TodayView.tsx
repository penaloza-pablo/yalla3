        ...
        <section className="today-cards" aria-label={t('pages.Today')}>
          ...
          >
            ...
            {cleaningDone ? (
              ...
              <ul className="today-metrics">
                ...
                <li>
                  <span>{t('today.currentCleanings')}</span>
                  <strong>
                    {formatRatio(
                      t,
                ...
                <li>
                  <span>{t('today.previousCleanings')}</span>
                  <strong>{summary.cleaning.previousOpen}</strong>
                </li>
              </ul>
            )}
          </button>
          ...
          >
            ...
            {maintenanceDone ? (
              ...
              <ul className="today-metrics">
                <li>
                  <span>{t('today.currentMaintenance')}</span>
                  <strong>
                    {formatRatio(
                      t,
                ...
                <li>
                  <span>{t('today.toEstimate')}</span>
                  <strong>{summary.maintenance.previousOpen}</strong>
                </li>
              </ul>
            )}
          </button>
          ...
          >
            ...
            {inventoryDone ? (
              ...
              <ul className="today-metrics">
                <li>
                  <span>{t('today.waitingDelivery')}</span>
                  <strong>{summary.inventory.waitingDelivery}</strong>
                </li>
                <li>
                  <span>{t('today.reorder')}</span>
                  <strong>{summary.inventory.reorder}</strong>
                </li>
                <li>
                  <span>{t('today.lowStock')}</span>
