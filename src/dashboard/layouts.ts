...
export const DASHBOARD_LAYOUT_2: DashboardLayout = {
  ...
  widgets: [
    ...
    { id: 'l2-5', widgetId: 'date.photo', colSpan: 2, rowSpan: 3 },
    { id: 'l2-6', widgetId: 'swatch.energy', colSpan: 2, rowSpan: 2 },
...
export const DASHBOARD_LAYOUT_3: DashboardLayout = {
  ...
  widgets: [
    ...
    { id: 'l3-2', widgetId: 'date.photo', colSpan: 2, rowSpan: 3 },
...
export const DASHBOARD_LAYOUT_4: DashboardLayout = {
  id: 'layout-4',
  widgets: [
    { id: 'l4-1', widgetId: 'date.photo', colSpan: 2, rowSpan: 3 },
